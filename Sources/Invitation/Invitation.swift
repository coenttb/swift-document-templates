...
extension Invitation { var reference: String { "\(recipient.id)-\(invitationNumber)" } }
...
extension Invitation {
    public struct Sender: Hashable, Equatable, Codable {
        ...
        public init(name: String, address: [String], phone: String, email: String, website: String)
        {
            self.name = name
...
extension TranslatedString {
    ...
    static let invitationNumber = TranslatedString(
        dutch: "Uitnodigingsnummer",
        english: "Invitation Number"
    )
    static let invitationDate = TranslatedString(
        dutch: "Uitnodigingsdatum",
        english: "Invitation Date"
    )
    ...
    static let eventInvitation = TranslatedString(
        dutch: "Evenement Uitnodiging",
...
extension Invitation.Sender {
    package static var preview: Self {
        .init(
            ...
            address: ["Straatnaam 1", "1234 AB Stad", "Nederland"],
            phone: "+31 6 12345678",
...
extension Invitation.Recipient {
    package static var preview: Self {
        .init(
            id: "INV123456",
            name: "Gast Naam",
            address: ["Adresweg 23", "5678 CD Plaats", "Nederland"]
        )
    }
}
...
extension Invitation {
    package static var preview: Self {
        .init(
            ...
            metadata: [
                .init(dutch: "Dresscode", english: "Dress Code"): .init(
                    dutch: "Zakelijk",
                    english: "Business"
                )
            ]
