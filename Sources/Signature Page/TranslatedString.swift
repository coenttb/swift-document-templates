...
extension TranslatedString {
    public static let signatures = TranslatedString(dutch: "Ondertekening", english: "Signatures")

    public static let signedAt = TranslatedString(dutch: "Getekend te", english: "Signed at")

    public static let signedOn = TranslatedString(dutch: "Getekend op", english: "Signed on")

    public static let onBehalfOf = TranslatedString(dutch: "Namens", english: "On behalf of")
    ...
    public static let date = TranslatedString(dutch: "datum", english: "date")

    public static let location = TranslatedString(dutch: "locatie", english: "location")
}
...
extension String { func repeated(_ count: Int) -> String { String(repeating: self, count: count) } }
